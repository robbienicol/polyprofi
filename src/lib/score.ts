 ...
 * shouldn't out-rank a capital-safe stock just because it needs little money and resolves
...
export function __selfCheck(): void {
  ...
  // Capital-destruction drag: a coin-flip binary bet must score below a capital-safe route
